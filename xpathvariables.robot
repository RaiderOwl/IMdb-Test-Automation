...
${browser}    chrome
${to}    30
${serie_circus}    The Circus
${serie_jazz_singer}    The Jazz Singer
...
${xpath_circus_link}    //*[@id="center-3-react"]/div/div/div[2]/h3/div/div/div//a[contains(text(),'${serie_circus}')]
${xpath_jazz_singer_link}    //*[@id="center-3-react"]/div/div/div[2]/h3/div/div/div//a[contains(text(),'${serie_jazz_singer}')]
...
${xpath_the_circus_div}    //*[@id="react-autowhatever-1--item-0"]/a/div[2]//div[contains(text(),'${serie_circus}')]
${xpath_jazz_singer_div}    //*[@id="react-autowhatever-1--item-0"]/a/div[2]//div[contains(text(),'${serie_jazz_singer}')]
